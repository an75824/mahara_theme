...
{/foreach}
	...
	<!-- With Blaze.css we can only specify the CSS modules that we are using -->
	<!-- For our experimental CSS we only used inputs, buttons and a card -->
	<link rel="stylesheet" type="text/css" href="https://unpkg.com/blaze/dist/components.inputs.min.css">
	<link rel="stylesheet" type="text/css" href="https://unpkg.com/blaze/dist/components.buttons.min.css">
	<link rel="stylesheet" type="text/css" href="https://unpkg.com/blaze/dist/components.cards.min.css">
    ...
    <script type="application/javascript" src="{theme_url filename='js/loginblock.js'}?v={$CACHEVERSION}"></script>
